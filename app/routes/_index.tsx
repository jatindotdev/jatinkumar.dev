    ...
    <div className="main-wrapper">
      <div className="container mx-auto">
        ...
        <div className="home-intro text-large content mt-l">
          <p>
            My name is Jatin and I am a student pursuing a Bachelor's degree in Computer
            Science. My specialty is in creating mobile and web-based applications with a
            strong emphasis on simplicity and usability, with a focus on building
          ...
          <p>
            ...
            Additionally, I am proficient in frontend and backend web development,
            utilizing frameworks such as{' '}
          ...
          <p>
            I am passionate about open-source and enjoy exploring and learning from
            open-sourced repositories. I also contribute to them whenever I can.
            Additionally, I prefer to keep my own projects open-sourced.
          </p>
        </div>
        <div className="home-links-list mt-l">
          ...
          <div className="space-x-2">
            ...
            <a href="https://cv.jatinkumar.dev" className="btn" rel="noreferrer">
              My CV
            </a>
          </div>
        </div>
